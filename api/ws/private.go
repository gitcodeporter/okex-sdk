...
import (
	...
	"github.com/gitcodeporter/okex-sdk/events/private"
	requests "github.com/gitcodeporter/okex-sdk/requests/ws/private"
)
...
func (c *Private) Account(req requests.Account, ch ...chan *private.Account) error {
	...
	return c.Subscribe(okex.PrivateURL, []okex.ChannelName{"account"}, m)
}
...
func (c *Private) UAccount(req requests.Account, rCh ...bool) error {
	...
	return c.Unsubscribe(okex.PrivateURL, []okex.ChannelName{"account"}, m)
}
...
func (c *Private) Position(req requests.Position, ch ...chan *private.Position) error {
	...
	return c.Subscribe(okex.PrivateURL, []okex.ChannelName{"positions"}, m)
}
...
func (c *Private) UPosition(req requests.Position, rCh ...bool) error {
	...
	return c.Unsubscribe(okex.PrivateURL, []okex.ChannelName{"positions"}, m)
}
...
func (c *Private) BalanceAndPosition(ch ...chan *private.BalanceAndPosition) error {
	...
	return c.Subscribe(okex.PrivateURL, []okex.ChannelName{"balance_and_position"}, m)
}
...
func (c *Private) UBalanceAndPosition(rCh ...bool) error {
	...
	return c.Unsubscribe(okex.PrivateURL, []okex.ChannelName{"balance_and_position"}, m)
}
...
func (c *Private) Order(req requests.Order, ch ...chan *private.Order) error {
	...
	return c.Subscribe(okex.PrivateURL, []okex.ChannelName{"orders"}, m)
}
...
func (c *Private) UOrder(req requests.Order, rCh ...bool) error {
	...
	return c.Unsubscribe(okex.PrivateURL, []okex.ChannelName{"orders"}, m)
}
