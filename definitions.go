...
const (
	...
	CandleStick1Mutc = CandleStickWsBarSize("candle1Mutc")
	CandleStick1W    = CandleStickWsBarSize("candle1W")
	CandleStick1Wutc = CandleStickWsBarSize("candle1Wutc")
	...
	CandleStick1Dutc = CandleStickWsBarSize("candle1Dutc")
